...
type
  ...
  public
    { Public declarations }
    OtdelNoWork: Integer;
    class function GetOstatok(pColnPrice, pVidNaklNo, pOtdelNo: integer; pReturn: Boolean): TOstRet;
  end;
...
uses data, MlekoPropFindTov,OstatokFiltr, TovarPrih, TovarPrihForDateOfManufacture, main;

{$R *.DFM}

class function TfmOstatok.GetOstatok(pColnPrice, pVidNaklNo, pOtdelNo: integer; pReturn: Boolean): TOstRet;
begin
