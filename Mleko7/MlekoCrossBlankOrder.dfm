inherited MlekoCrossBlankOrderForm: TMlekoCrossBlankOrderForm
  ...
  inherited ToolBar: TToolBar
    ...
    object ToolButtonShowCuttiung: TToolButton
      Left = 246
      Top = 0
      Hint = #1055#1086#1082#1072#1079#1072#1090#1100' '#1087#1086#1088#1077#1079#1082#1091
      Caption = 'ToolButtonShowCuttiung'
      ImageIndex = 22
      OnClick = ToolButtonShowCuttiungClick
    end
  ...
  object quCheckEnabledToolButtonCuttingMesh: TMSQuery
    Connection = dmDataModule.DB
    SQL.Strings = (
      'select * '
      ' from e_blanksTMP '
      
        '  where TovarNo in (select TovarNo from Tovar where VidNo = :p1_' +
        'VidNo)'
