object ListPlusPostForDolgForm: TListPlusPostForDolgForm
  Left = 969
  Top = 213
  Width = 482
  Height = 336
  Caption = 'ListPlusPostForDolgForm'
  Color = clBtnFace
  ...
  object DBGridEh1: TDBGridEh
    ...
    Height = 257
    Align = alClient
    DataSource = dsListPlusPostForDolg
    Flat = False
  ...
  object dsListPlusPostForDolg: TMSDataSource
    DataSet = quListPlusPostForDolg
  end
  object quListPlusPostForDolg: TMSQuery
    SQLUpdate.Strings = (
      'update ListPlusPostForDolg'
    ...
    SQL.Strings = (
      ...
      '      ,p.Name'
      '      ,lmp.CheckPlus'
      ' from ListPlusPostForDolg lmp inner join'
      '      Post p on p.PostNo = lmp.PostNo')
    Left = 24
    object quListPlusPostForDolgPostNo: TSmallintField
      FieldName = 'PostNo'
    end
    object quListPlusPostForDolgName: TStringField
      FieldName = 'Name'
      Size = 30
    end
    object quListPlusPostForDolgCheckPlus: TBooleanField
      FieldName = 'CheckPlus'
    end
  end
  object spInsInListPlusPostForDolg: TMSStoredProc
    StoredProcName = 'InsInListPlusPostForDolg'
    Connection = dmDataModule.DB
    SQL.Strings = (
      '{:RETURN_VALUE = CALL InsInListPlusPostForDolg (:SPID, :UserNo)}')
    Left = 424
    Top = 232
    ParamData = <
      item
