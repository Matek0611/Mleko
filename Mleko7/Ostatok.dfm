inherited fmOstatok: TfmOstatok
  Left = 333
  Top = 230
    ...
    object RxDBGrid1: TcitDBGrid
      ...
      Columns = <
        ...
        item
          ...
          Expanded = False
          FieldName = 'kol_all'
          Title.Caption = #1050#1086#1083'+'#1088#1077#1079
          Width = 56
          Visible = True
        end
        item
  ...
  object quOstatok: TMSQuery
    ...
    SQL.Strings = (
      'SELECT   o.tovarno'
      '         ,o.kol-isnull(res.qty,0) as kol'
      '         ,isnull(res.qty,0) as res_qty'
      '         ,o.kol as kol_all'
      '         ,o.price'
      '         ,o.kolhold'
      '         ,t.nametovar'
      ...
      '         ,t.weight'
      'FROM     ostatok o'
      '         INNER JOIN tovar t ON o.tovarno = t.TovarNo'
      '         LEFT OUTER JOIN vidtov v ON v.vidno = t.vidno'
      
        '         left outer join (select s.article_id,sum(s.qty) as qty ' +
        'from DSPEC s where s.STATE_ID=4 group by s.ARTICLE_ID) res on o.' +
        'TovarNo=res.ARTICLE_ID'
      '         left join PriceForVeb pfv on pfv.TovarNo = o.TovarNo'
      '         where &_where  &_flt'
      'ORDER BY v.vidname'
      '         ,nametovar')
  ...
  object ActionList1: TActionList
    ...
    object ActionFind: TAction
      ...
      Hint = #1055#1086#1080#1089#1082' '#1090#1086#1074#1072#1088#1072
      ImageIndex = 20
      ShortCut = 16454
  ...
  object quTovarDateOfManufacture: TMSQuery
    ...
    object quTovarDateOfManufactureDateBegStart: TDateTimeField
      DisplayLabel = #1044#1072#1090#1072' '#1086#1090#1089#1095#1077#1090#1072' '#1087#1086' '#1073#1088#1077#1085#1076#1091
      FieldName = 'DateBegStart'
    end
  end
