...
procedure TMlekoClosePlatRForm.DBGridEh1Columns2GetCellParams(
...
procedure TMlekoClosePlatRForm.DBGridEh1CellClick(Column: TColumnEh);
begin
  inherited;
//  DSLinkSumma.DataSet.FieldByName('BeforeSummaAccauntCurrency').AsFloat := DSLinkSumma.DataSet.FieldByName('BeforeSumma').AsFloat;
end;

procedure TMlekoClosePlatRForm.DSLinkSummaDataChange(Sender: TObject;
  Field: TField);
begin
  inherited;
//  if DSLinkSumma.DataSet.State in [dsInsert, dsEdit] then DSLinkSumma.DataSet.FieldByName('BeforeSummaAccauntCurrency').AsFloat := DSLinkSumma.DataSet.FieldByName('BeforeSumma').AsFloat;
...
procedure TMlekoClosePlatRForm.DBGridEh1KeyPress(Sender: TObject;
  var Key: Char);
begin
  inherited;
{
