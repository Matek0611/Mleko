object fmOtchet2_1: TfmOtchet2_1
  Left = 0
  Top = 0
  Width = 816
  Height = 1056
  ...
  object quPrihod: TMSQuery
    ...
    SQL.Strings = (
        ...
        'select Sum(Kol*Price) Summa,SUM(Kol) Kol,Prihod.TovarNo,Tovar.Na' +
        'meTovar'
      'from Prihod,NaklP,Tovar'
      'where (NaklP.DateNakl>=:DateBegin)   and'
      '      (NaklP.DateNakl<=:DateEnd)     and'
      '      (Prihod.TovarNo=Tovar.TovarNo) and'
      '      (Prihod.NaklNo=NaklP.NaklNo)   and'
      '      (NaklP.Buh in &Tip)'
      'group by Prihod.TovarNo,Tovar.NameTovar'
    ...
    object quPrihodSumma: TFloatField
      FieldName = 'Summa'
      DisplayFormat = '#,##0.00'
    end
    ...
    object quPrihodTovarNo: TSmallintField
      FieldName = 'TovarNo'
    end
