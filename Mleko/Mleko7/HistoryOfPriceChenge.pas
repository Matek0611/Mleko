...
type
  THistoryOfPriceChengeForm = class(TMlekoForm)
    Panel1: TPanel;
    ...
    quHistoriPriceCurrency: TStringField;
...
var
  HistoryOfPriceChengeForm: THistoryOfPriceChengeForm;
...
procedure THistoryOfPriceChengeForm.DBGridEh1KeyPress(Sender: TObject;
  var Key: Char);
var
 Found:boolean;
begin
...
procedure THistoryOfPriceChengeForm.DBGridEh1KeyDown(Sender: TObject;
...
procedure THistoryOfPriceChengeForm.DBGridEh1TitleBtnClick(Sender: TObject;
...
procedure THistoryOfPriceChengeForm.gBPeriodExit(Sender: TObject);
begin
  inherited;
{
...
procedure THistoryOfPriceChengeForm.FormCreate(Sender: TObject);
begin
  inherited;
  IsEnabledDAte := false;
...
procedure THistoryOfPriceChengeForm.DBLookupComboboxEhVidNameChange(
  Sender: TObject);
begin
  inherited;
{
...
procedure THistoryOfPriceChengeForm.Button1Click(Sender: TObject);
begin
  inherited;
  quHistoriPrice.Close;
  quHistoriPrice.ParamByName('DateBeg').Value := EdDateBeg.Date;
...
procedure THistoryOfPriceChengeForm.Button2Click(Sender: TObject);
begin
  inherited;
  inherited;
