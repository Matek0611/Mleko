object fmOtchet5_2: TfmOtchet5_2
  Left = 0
  Top = 0
  Width = 794
  Height = 1123
  ...
  object quPlatR: TMSQuery
    ...
    SQL.Strings = (
      'select PlatR.DatePlat,PlatR.Nom,PlatR.Summa,PlatR.Spravka,'
      '       TipNakl.TipName BuhName'
      'from PlatR,TipNakl'
      'where (PlatR.PostNo=:PostNo)       and'
      '      (PlatR.DatePlat>=:DateBegin) and'
      '      (PlatR.DatePlat<=:DateEnd)   and'
      '      (PlatR.Buh in &Tip)          and'
      
        '      (PlatR.Buh=TipNakl.TipNo) and PlatR.is_econom=0 and PlatR.' +
        'OurFIrmNo= :OurFirmNo'
      'order by PlatR.DatePlat')
    ...
    object quPlatRBuhName: TStringField
      FieldName = 'BuhName'
      Size = 10
    end
  end
