inherited MlekoClosePlatRLightForm: TMlekoClosePlatRLightForm
  Left = 297
  Top = 176
  Width = 1337
  Height = 844
  Caption = #1046#1091#1088#1085#1072#1083' '#1056#1072#1089#1093#1086#1076#1086#1074' '#1054#1073#1083#1077#1075#1095#1077#1085#1085#1099#1081
  PixelsPerInch = 96
  TextHeight = 13
    ...
    inherited TabSheet1: TTabSheet
      ...
      inherited FilterPanel: TTargetFilter_Panel
        ...
        object flt_Buh: TcitDBComboEdit
          ...
          Owner = 'MlekoClosePlatRLightForm'
        ...
        object flt_entity_type: TcitDBComboEdit
          ...
          SqlFilter = 'code in ('#39'PLATP'#39','#39'PLATR'#39')'
          multiselect = True
          EditStyle = edSelect
          AutoTabControl = True
        end
