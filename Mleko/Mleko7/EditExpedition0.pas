...
uses
  Windows, Messages, SysUtils, Variants, Classes, Graphics, Controls, MlekoForm, Dialogs, DB, StdCtrls, Buttons, Mask, DBCtrls, ExtCtrls, DBAccess, MsAccess, MemDS, DBGridEh, ImgList, GridsEh, ActnList, Forms;
...
type
  TfmEditExpedition = class(TMlekoForm)
    ...
    procedure edCarsKeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
    ...
    procedure edShipping_AgentKeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
...
uses
  Expedition0, Cars0, Data, Shipping_Agent0, ExpeditionNakl0, GetPeriodDate0, SelectItem0, Otchets0;
...
procedure TfmEditExpedition.edCarsKeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
...
procedure TfmEditExpedition.edShipping_AgentKeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
  if Key = VK_RETURN then
    ChangeShipping_Agent;
end;
...
procedure TfmEditExpedition.DBGridEh1KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
var
  FoundNaklNo: integer;
begin
  case Key of
...
procedure TfmEditExpedition.DBGridEh1KeyPress(Sender: TObject; var Key: Char);
var
  Found: boolean;
begin
...
procedure TfmEditExpedition.DBGridEh1TitleBtnClick(Sender: TObject; ACol: Integer; Column: TColumnEh);
var
  FindNaklRNo: integer;
  MacroValue: string;
  OldColumn: TColumnEh;
  ...
  begin
    ...
    case ACol of
      ...
      6:
        MacroValue := 'h.Summa';
      10:
        MacroValue := 'h.OrderInFlight';
      11:
        MacroValue := 'h.ArrivalTime';
    end;
    if Descending then
...
procedure TfmEditExpedition.DBGridEh1DrawColumnCell(Sender: TObject; const Rect: TRect; DataCol: Integer; Column: TColumnEh; State: TGridDrawState);
begin
...
procedure TfmEditExpedition.DBGridEh1GetCellParams(Sender: TObject; Column: TColumnEh; AFont: TFont; var Background: TColor; State: TGridDrawState);
begin
  if quNaklRSourceTable.AsString = 'E_BLANK_HEAD' then
