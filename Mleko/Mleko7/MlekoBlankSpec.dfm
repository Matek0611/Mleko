inherited MlekoBlankSpecForm: TMlekoBlankSpecForm
  ...
  object quBlankParam: TMSQuery
    ...
    SQL.Strings = (
      'select v.*'
        ...
        ',case when v.summain>0 then round(100*(v.summa-v.summaIn)/v.summ' +
        'ain,2) else 0 end as Procent'
  ...
  object GenInputOrder: TMSStoredProc
    ...
    object GenInputOrderID: TIntegerField
      FieldName = 'ID'
      Origin = '#tmp_out.ID'
    end
    ...
    object GenInputOrderTovarNo: TIntegerField
      FieldName = 'TovarNo'
      Origin = '#tmp_out.TovarNo'
    end
    ...
    object GenInputOrderKolPerPak: TSmallintField
      FieldName = 'KolPerPak'
      Origin = '#tmp_out.KolPerPak'
    end
