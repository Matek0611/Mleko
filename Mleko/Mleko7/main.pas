...
procedure TfmMain.IsEconomClick(Sender: TObject);
begin
  inherited;
  begin
     with TListPlusPostForClosePlatRIsEconomForm.Create(Application) do
       try
         quListPlusPostForClosePlatRIsEconom.Open;
         ShowModal;
       finally
         quListPlusPostForClosePlatRIsEconom.Close;
         Free;
       end;
  end;
end;
