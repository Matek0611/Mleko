...
type
  TMlekoBlankListLightForm = class(TCFLMLKListForm)
    ...
    GbReason: TGroupBox;
    DbLCbReason: TcxDBLookupComboBox;
    QuReason: TMSQuery;
...
var
  ...
  ld_date: TDate;
  MlekoBlankListLightForm: TMlekoBlankListLightForm;
...
class procedure TMlekoBlankListLightForm.ShowListForm(aDeptID: integer; aDate: TDate; is_AutoLoad: boolean = false);
var
...
procedure TMlekoBlankListLightForm.ActionItemAddExecute(Sender: TObject);
var
  DocumentId: Int64;
  Res:Boolean;
begin
...
procedure TMlekoBlankListLightForm.DBGridDblClick(Sender: TObject);
var
  i,e:Integer;
   a:string;
begin
...
procedure TMlekoBlankListLightForm.DBGridKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
var
  i,e:Integer;
  a:string;
...
procedure TMlekoBlankListLightForm.ActionItemPropExecute(Sender: TObject);
var
  documentId: Int64;
begin
  inherited;
...
procedure TMlekoBlankListLightForm.ActionGoBlankExecute(Sender: TObject);
var
  documentId: Int64;
  Period: TPeriodDate;
...
procedure TMlekoBlankListLightForm.ActionRestoreExecute(Sender: TObject);
var
  documentId: Int64;
  Dlg: TMlekoBlankParamForm;
  quSumDocum : TMSQuery;
...
procedure TMlekoBlankListLightForm.ActionDelFromBlankExecute(Sender: TObject);
var
  documentId: Int64;
begin
  inherited;
...
procedure TMlekoBlankListLightForm.ActionItemDelExecute(Sender: TObject);
var
  documentId: Int64;
begin
  inherited;
...
procedure TMlekoBlankListLightForm.SetActionsEnabled;
var
...
procedure TMlekoBlankListLightForm.ActionSpecPrintExecute(Sender: TObject);
...
procedure TMlekoBlankListLightForm.DBLookupComboBoxDeptsClick(Sender: TObject);
var
  otdelNo: integer;
begin
  inherited;
...
procedure TMlekoBlankListLightForm.ActionOpenCrossGridExecute(Sender: TObject);
begin
  inherited;
...
procedure TMlekoBlankListLightForm.ActionAllCorrelatiOnExecute(Sender: TObject);
var
  Period: TPeriodDate;
...
procedure TMlekoBlankListLightForm.ActionDelAllFromNaklRExecute(
  Sender: TObject);
var
  i: Integer;
begin
...
procedure TMlekoBlankListLightForm.ActionOrderBlockExecute(Sender: TObject);
begin
  inherited;
...
procedure TMlekoBlankListLightForm.ActionOrderUnBlockExecute(Sender: TObject);
begin
  inherited;
  spSetOrderReserve.Close;
  spSetOrderReserve.Params.ParamByName('p_document_id').Value := Query.FieldByName('document_ID').Value;
...
procedure TMlekoBlankListLightForm.DBGridDrawDataCell(Sender: TObject;
...
procedure TMlekoBlankListLightForm.SQLBuilderGetParams(Sender: TObject;
  var Params: TParams);
var
...
function TMlekoBlankListLightForm.ftTovarIsSelect(Sender: TObject): Boolean;
var
  ID: Integer;
begin
  inherited;
...
function TMlekoBlankListLightForm.FilterFirma_OnSelectValue(
  Sender: TTargetFilter_DictionaryFilter; BtnBoundsRect: TRect;
  ConditionType: TDictionaryConditionType;
  ConditionGroup: TDictionaryConditionGroup; var Rec_PK,
  Rec_Title: Variant): Boolean;
...
procedure TMlekoBlankListLightForm.ActionItemCopyExecute(Sender: TObject);
var
  l_id: integer;
...
procedure TMlekoBlankListLightForm.ActionAutoLoadAllExecute(Sender: TObject);
begin
  inherited;
...
function TMlekoBlankListLightForm.CopyBlank(p_document_id: integer): Integer;
begin
  ///
end;

procedure TMlekoBlankListLightForm.ActionCheckNaklExecute(Sender: TObject);
var
  Params: TParams;
begin
  inherited;
...
function TMlekoBlankListLightForm.DBGridGetKey(Sender: TObject;
...
procedure TMlekoBlankListLightForm.ActionViewRefreshExecute(Sender: TObject);
begin
  inherited;
  quSumma.Close;
...
procedure TMlekoBlankListLightForm.FormActivate(Sender: TObject);
begin
  inherited;
  if Query.Active then Query.Refresh;
end;

procedure TMlekoBlankListLightForm.OpenSpec(p_id: Integer);
var
...
procedure TMlekoBlankListLightForm.ActionOpenSpecExecute(Sender: TObject);
begin
  inherited;
  OpenSpec(Query.FieldByName('document_id').Value);
end;

procedure TMlekoBlankListLightForm.DBGridMouseDown(Sender: TObject;
...
procedure TMlekoBlankListLightForm.DBGridKeyUp(Sender: TObject; var Key: Word;
  Shift: TShiftState);
  var
i,e:Integer;
a:string;
...
procedure TMlekoBlankListLightForm.ToolButtonTmpCrossClick(Sender: TObject);
begin
  inherited;
  Edit_CrossBlankOrder := True;
