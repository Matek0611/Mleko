...
type
  ...
  private
    ...
    procedure AddTovarInBlanks (DocumentId, TovarNo, UserNo : integer; KolBeg, KolEnd, Boss_Price : double);
...
procedure TMlekoBlankListOutSideForm.AddTovarInBlanks (DocumentId, TovarNo, UserNo : integer; KolBeg, KolEnd, Boss_Price : double);
begin
end;
