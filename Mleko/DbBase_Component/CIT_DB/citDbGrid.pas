...
{     Data := VarArrayCreate([0,DataSource.DataSet.RecordCount-1,0,DataSource.DataSet.FieldCount-1],varVariant);
     j := 0;
     DataSource.DataSet.First;
     while not DataSource.DataSet.Eof do begin
       k:=1;
     ...
     WorkBook.WorkSheets[1].Range['A2',WorkBook.WorkSheets[1].Cells.Item[DataSource.Dataset.RecordCount+1,DataSource.Dataset.FieldCount]].Value :=Data;
     Data := Unassigned;
}
     Excel.Visible := true;
     Excel := UnAssigned;
