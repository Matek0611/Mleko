...
//    FNearestRecordID: Variant;
  ...
  protected
    ...
    function CompareBookmarks(const AItem1, AItem2: TcxBookmark): Integer; overload; virtual;
  {$IFDEF DELPHI12}
    function CompareBookmarks(const AItem1: string; const AItem2: TcxBookmark): Integer; overload;
    function CompareBookmarks(const AItem1, AItem2: string): Integer; overload;
  {$ENDIF}
  ...
  protected
    ...
    function CompareBookmarks(const AItem1, AItem2: TcxBookmark): Integer; overload;
  {$IFDEF DELPHI12}
    function CompareBookmarks(const AItem1: string; const AItem2: TcxBookmark): Integer; overload;
    function CompareBookmarks(const AItem1, AItem2: string): Integer; overload;
  {$ENDIF}
...
function cxBookMarkToString(const ABookmark: TcxBookmark): string; {$IFDEF DELPHI9} inline; {$ENDIF}
begin
{$IFDEF DELPHI12}
  Result := StringOf(ABookmark);
{$ELSE}
  Result := ABookmark;
{$ENDIF}
end;

function cxStringToBookMark(const ABookmark: string): TcxBookmark; {$IFDEF DELPHI9} inline; {$ENDIF}
begin
{$IFDEF DELPHI12}
  Result := BytesOf(ABookmark);
{$ELSE}
  Result := ABookmark;
{$ENDIF}
end;
        ...
        try
          ...
          begin
            if DataController.CanSelectRow(-1) then
              FBookmarks.Add(cxBookMarkToString(DataSet.Bookmark));
            Next;
          end;
          SyncCount;
        except
  ...
  begin
    ...
    begin
      ...
      begin
        FBookmarks.Clear;
        if DataController.CanSelectRow(-1) then
          FBookmarks.Add(cxBookmarkToString(ABkm1));
        Result := True;
      end
      else
          ...
          begin
            ...
            begin
              ...
              begin
                ...
                if DataController.CanSelectRow(-1) then
                  FBookmarks.Add(cxBookmarkToString(ABkm2));
                Result := True;
              end;
            end;
          end;
          ...
          begin
            ...
            begin
              ...
              begin
                ...
                if DataController.CanSelectRow(-1) then
                  FBookmarks.Insert(0, cxBookmarkToString(ABkm1));
                Result := True;
              end;  
            end;
          end;
        ...
        begin
          ...
          begin
            ...
            begin
              ...
              begin
                if DataController.CanSelectRow(-1) then
                  FBookmarks.Insert(I, cxBookmarkToString(ABkm));
                Inc(AIndex1);
                Inc(AIndex2);
                AFound := True;
                Break;
            ...
            begin
              if DataController.CanSelectRow(-1) then
                FBookmarks.Add(cxBookMarkToString(ABkm));
            end;
          end
          else
          begin
...
function TcxDBDataSelection.CompareBookmarks(const AItem1: string; const AItem2: TcxBookmark): Integer;
begin
  Result := DataController.Provider.CompareBookmarks(AItem1, AItem2);
end;

function TcxDBDataSelection.CompareBookmarks(const AItem1, AItem2: string): Integer;
begin
  Result := DataController.Provider.CompareBookmarks(AItem1, AItem2);
end;
...
begin
  ...
  FBookmarks.Insert(AIndex, cxBookMarkToString(GetRowBookmark(ARowIndex)));
end;
...
begin
  ...
  begin
    ...
    for I := Count - 1 downto 0 do
      if (FBookmarks[I] = '') or
        not DataController.Provider.BookmarkValid(cxStringToBookmark(FBookmarks[I])) then
        begin
          Result := True;
          Delete(I);
        end;
...
function TcxDBDataProvider.CompareBookmarks(const AItem1: string; const AItem2: TcxBookmark): Integer;
begin
  Result := CompareBookmarks(cxStringToBookmark(AItem1), AItem2);
end;

function TcxDBDataProvider.CompareBookmarks(const AItem1, AItem2: string): Integer;
begin
  Result := CompareBookmarks(cxStringToBookmark(AItem1), cxStringToBookmark(AItem2));
end;
  ...
  begin
    ...
    begin
      ...
      try
        ...
        begin
          DataSet.Bookmark := cxStringToBookmark(ASelection.FBookmarks[I]);
          DataSet.Delete;
          ASelection.Delete(I);
        end;
      finally
...
begin
  if not IsGridMode or (ARowIndex < 0) then
    ...
    Result := cxBookMarkToString(DBSelection.GetRowBookmark(ARowIndex));
end;
...
begin
  ...
  if IsFocusedSelectedMode then
    ...
    Result := cxStringToBookmark(DBSelection.FBookmarks[Index]);
end;
...
begin
  ...
  begin
    ...
    ABookmark := cxStringToBookmark(ASelection.FBookmarks[Index]);
