...
type
  ...
  public
    ...
    property HasValues[Index : Integer] : AnsiChar read GetHasValues write SetHasValues;
  end;
...
begin
  ...
  begin
    WriteByte(AData, 1);
    cxCopyData(Buffer, AData, 0, SizeOf(Byte), FDataSize);
  end;
  if FIsNeedAutoInc then
...
procedure TdxCustomMemData.CreateFieldsFromDataSet(DataSet : TDataSet);
var
  AField : TField;
  i : Integer;
begin
