...
{$ELSE}
  DsgnIntf, Menus,
{$ENDIF}
  Classes, Forms, SysUtils, cxLibraryReg, dxCore, cxPC, cxPCConsts, cxPCPaintersFactory;
...
type
  ...
  TcxTabControlComponentEditor = class(TcxComponentEditor)
  protected
...
{$ENDIF}  
  ...
  RegisterComponents('Dev Express', [TcxTabControl, TcxPageControl]);
