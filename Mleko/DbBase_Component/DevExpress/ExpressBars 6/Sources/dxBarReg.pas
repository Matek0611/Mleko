...
{$ELSE}
  DsgnIntf, Menus,
{$ENDIF}
  Windows, Classes, Controls, Graphics, cxDesignWindows, dxBar, Contnrs,
...
uses
  Messages, SysUtils, Forms, Dialogs,TypInfo, EditIntf, TreeIntf, dxBarCustForm,
  dxBarPopupMenuEd, dxBarStrs, dxRegEd, cxClasses, cxComponentCollectionEditor,
