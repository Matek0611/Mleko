...
public
    ...
    { UseFeeder simplifies the usage of EnableFeeder/DisableFeeder. Just set
      the property to True to use the feeder, or False to not use the feeder }
