...
ICAP_AUTOBRIGHT        = $01100; //mdm 02/18/2003
ICAP_PHYSICALWIDTH     = $01111; //mdm 02/19/2003
ICAP_PHYSICALHEIGHT    = $01112; //mdm 02/19/2003

TWUN_INCHES            = 0;
TWUN_CENTIMETERS       = 1; //mdm 02/19/2003
TWUN_PICAS             = 2; //mdm 02/19/2003
TWUN_POINTS            = 3; //mdm 02/19/2003
TWUN_TWIPS             = 4; //mdm 02/19/2003
TWUN_PIXELS            = 5; //mdm 02/19/2003

CAP_XFERCOUNT          = $00001;
CAP_FEEDERENABLED      = $01002;
CAP_FEEDERLOADED       = $01003;
CAP_INDICATORS         = $0100b; //mdm 02/18/2003
...
begin
    ...
    // 15.04.2008 Patrik Brudere: Fix slow Twain-UI-building -------------------
    if (Msg.Message in [WM_SIZE, WM_PAINT]) or (Msg.Message = WM_TIMER) then
    begin
        Result := False;
        Exit;
    end;
