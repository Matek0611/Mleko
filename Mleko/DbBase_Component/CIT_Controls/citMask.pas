...
uses Windows, SysUtils, Classes, citCtrls, Controls, Messages,
  Forms, Graphics, Menus, Dialogs;
...
{ TcitCustomMaskEdit }
  ...
  TcitCustomMaskEdit = class(TcitCustomEdit)
  private
    FEditMask: string;
    FMaskBlank: Char;
    FMaxChars: Integer;
...
{ TMaskEdit }
  ...
  TcitMaskEdit = class(TcitCustomMaskEdit)
  published
    property AutoSelect;
    property AutoSize;
...
constructor TcitCustomMaskEdit.Create(AOwner: TComponent);
begin
...
procedure TcitCustomMaskEdit.KeyDown(var Key: Word; Shift: TShiftState);
begin
...
procedure TcitCustomMaskEdit.KeyUp(var Key: Word; Shift: TShiftState);
begin
...
procedure TcitCustomMaskEdit.KeyPress(var Key: Char);
begin
...
procedure TcitCustomMaskEdit.WMLButtonDown(var Message: TWMLButtonDown);
begin
  inherited;
  FBtnDownX := Message.XPos;
end;

procedure TcitCustomMaskEdit.WMLButtonUp(var Message: TWMLButtonUp);
var
...
procedure TcitCustomMaskEdit.WMSetFocus(var Message: TWMSetFocus);
begin
  inherited;
  if (IsMasked) then
    CheckCursor;
...
procedure TcitCustomMaskEdit.SetEditText(const Value: string);
begin
...
function TcitCustomMaskEdit.GetEditText: string;
begin
  Result := inherited Text;
end;

function TcitCustomMaskEdit.GetTextLen: Integer;
begin
  Result := Length(Text);
end;

function TcitCustomMaskEdit.GetText: string;
begin
...
procedure TcitCustomMaskEdit.SetText(const Value: string);
var
  OldText: string;
  Pos: Integer;
begin
  ...
  begin
    ...
    if not (msDBSetText in FMaskState) and
      ...
      raise EDBEditError.Create(SMaskErr);
    EditText := OldText;
  end;
end;

procedure TcitCustomMaskEdit.WMCut(var Message: TMessage);
begin
  if not (IsMasked) then
    inherited
  else
...
procedure TcitCustomMaskEdit.WMPaste(var Message: TMessage);
var
  Value: string;
  Str: string;
  SelStart, SelStop : Integer;
...
function TcitCustomMaskEdit.GetMasked: Boolean;
begin
  Result := EditMask <> '';
end;

function TcitCustomMaskEdit.GetMaxChars: Integer;
begin
  if IsMasked then
    Result := FMaxChars
  else
...
procedure TcitCustomMaskEdit.ReformatText(const NewMask: string);
var
  OldText: string;
begin
...
procedure TcitCustomMaskEdit.SetEditMask(const Value: string);
var
  SelStart, SelStop: Integer;
begin
...
function TcitCustomMaskEdit.GetMaxLength: Integer;
begin
  Result := inherited MaxLength;
end;

procedure TcitCustomMaskEdit.SetMaxLength(Value: Integer);
begin
  if not IsMasked then
...
procedure TcitCustomMaskEdit.GetSel(var SelStart: Integer; var SelStop: Integer);
begin
  SendMessage(Handle, EM_GETSEL, Integer(@SelStart), Integer(@SelStop));
end;

procedure TcitCustomMaskEdit.SetSel(SelStart: Integer; SelStop: Integer);
begin
  SendMessage(Handle, EM_SETSEL, SelStart, SelStop);
end;

procedure TcitCustomMaskEdit.SetCursor(Pos: Integer);
var
  SelStart, SelStop: Integer;
...
procedure TcitCustomMaskEdit.CheckCursor;
var
  SelStart, SelStop: Integer;
begin
...
procedure TcitCustomMaskEdit.Clear;
begin
  Text := '';
end;

function TcitCustomMaskEdit.EditCanModify: Boolean;
begin
  Result := True;
end;

procedure TcitCustomMaskEdit.Reset;
begin
  if Modified then
  begin
    EditText := FOldValue;
...
function TcitCustomMaskEdit.CharKeys(var CharCode: Char): Boolean;
var
  SelStart, SelStop : Integer;
  Txt: string;
  CharMsg: TMsg;
...
procedure TcitCustomMaskEdit.ArrowKeys(CharCode: Word; Shift: TShiftState);
var
  SelStart, SelStop : Integer;
begin
...
procedure TcitCustomMaskEdit.CursorInc(CursorPos: Integer; Incr: Integer);
var
  NuPos: Integer;
begin
...
procedure TcitCustomMaskEdit.CursorDec(CursorPos: Integer);
var
  nuPos: Integer;
begin
  nuPos := CursorPos;
...
function TcitCustomMaskEdit.GetFirstEditChar: Integer;
begin
  Result := 0;
  if IsMasked then
...
function TcitCustomMaskEdit.GetLastEditChar: Integer;
begin
  Result := GetMaxChars;
  if IsMasked then
...
function TcitCustomMaskEdit.GetNextEditChar(Offset: Integer): Integer;
begin
  Result := Offset;
...
function TcitCustomMaskEdit.GetPriorEditChar(Offset: Integer): Integer;
begin
  Result := Offset;
...
procedure TcitCustomMaskEdit.HomeEndKeys(CharCode: Word; Shift: TShiftState);
var
  SelStart, SelStop : Integer;
begin
  GetSel(SelStart, SelStop);
...
procedure TcitCustomMaskEdit.DeleteKeys(CharCode: Word);
var
  SelStart, SelStop : Integer;
  NuSelStart: Integer;
  Str: string;
...
procedure TcitCustomMaskEdit.CMEnter(var Message: TCMEnter);
begin
...
procedure TcitCustomMaskEdit.CMTextChanged(var Message: TMessage);
var
  SelStart, SelStop : Integer;
  Temp: Integer;
begin
...
procedure TcitCustomMaskEdit.CMWantSpecialKey(var Message: TCMWantSpecialKey);
begin
  inherited;
...
procedure TcitCustomMaskEdit.CMExit(var Message: TCMExit);
begin
  if IsMasked and not (csDesigning in ComponentState) then
  begin
    ValidateEdit;
...
procedure TcitCustomMaskEdit.ValidateEdit;
var
  Str: string;
  Pos: Integer;
begin
...
procedure TcitCustomMaskEdit.ValidateError;
var
  Str: string;
begin
  MessageBeep(0);
...
function TcitCustomMaskEdit.AddEditFormat(const Value: string; Active: Boolean): string;
begin
  if not Active then
    Result := MaskDoFormatText(EditMask, Value, ' ')
  else
...
function TcitCustomMaskEdit.RemoveEditFormat(const Value: string): string;
var
  I: Integer;
  OldLen: Integer;
  Offset, MaskOffset: Integer;
...
function TcitCustomMaskEdit.InputChar(var NewChar: Char; Offset: Integer): Boolean;
var
  MaskOffset: Integer;
  CType: TMaskCharType;
  InChar: Char;
...
function TcitCustomMaskEdit.DoInputChar(var NewChar: Char; MaskOffset: Integer): Boolean;
var
  Dir: TMaskDirectives;
  Str: string;
  CType: TMaskCharType;
...
function TcitCustomMaskEdit.Validate(const Value: string; var Pos: Integer): Boolean;
var
  Offset, MaskOffset: Integer;
  CType: TMaskCharType;
begin
...
function TcitCustomMaskEdit.DeleteSelection(var Value: string; Offset: Integer;
  Len: Integer): Boolean;
var
  EndDel: Integer;
...
function TcitCustomMaskEdit.InputString(var Value: string; const NewValue: string;
  Offset: Integer): Integer;
var
...
function TcitCustomMaskEdit.FindLiteralChar(MaskOffset: Integer; InChar: Char): Integer;
var
  CType: TMaskCharType;
  LitChar: Char;
begin
