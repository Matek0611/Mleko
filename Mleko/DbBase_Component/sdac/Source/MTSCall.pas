...
{$ENDIF}
  _DtcGetTransactionManagerEx = function(pszHost: PChar; pszTmName: PChar;
...
{$IFDEF CLR}
  ...
  function xolehlp_DtcGetTransactionManagerEx(pszHost: PChar; pszTmName: PChar; riid: IntPtr; grfOptions: Integer;
