...
uses
{$IFDEF CLR}
  System.Runtime.InteropServices, MemUtils, Variants,
{$ELSE}
  CLRClasses,
{$ENDIF}
...
{$ENDIF}
  ...
  IID_ISSAsynchStatus: TGUID = '{1FF1F743-8BB0-4c00-ACC4-C10E43B08FC1}';
  ...
  DBSCHEMA_CHECK_CONSTRAINTS_BY_TABLE: TGUID = '{C8B52301-5CF3-11CE-ADE5-00AA0044773D}';
  ...
  DBSCHEMA_TABLE_STATISTICS: TGUID = '{C8B522FF-5CF3-11CE-ADE5-00AA0044773D}';
  ...
  DBPROPSET_STREAM: TGUID = '{C8B522FD-5CF3-11CE-ADE5-00AA0044773D}';

  // SQL Everywhere Provider Specific Property Sets
  DBPROPSET_SSCE_DBINIT: TGUID = '{2B9AB5BA-4F6C-4ddd-BF18-24DD4BD41848}';
  DBPROPSET_SSCE_COLUMN: TGUID = '{352CC8D5-9181-11d3-B27B-00C04F68DBFF}';
  DBPROPSET_SSCE_ROWSET: TGUID = '{5C17C602-A107-11d3-B27B-00C04F68DBFF}';
  DBPROPSET_SSCE_SESSION: TGUID = '{22FE7D33-5E5C-4a45-B723-8BED2374A06B}';
...
const
  ...
  DBPROP_OUTPUTSTREAM	= $0000011e;
  DBPROP_OUTPUTENCODING	= $0000011f;
...
// SQL Everywhere Provider specific properties
const
  DBPROP_SSCE_COL_ROWGUID             = $000001F9;      // SSCE_COLUMN
  DBPROP_SSCE_MAXBUFFERSIZE           = $000001FA;      // SSCE_DBINIT
  DBPROP_SSCE_DBPASSWORD              = $000001FB;      // SSCE_DBINIT
  DBPROP_SSCE_ENCRYPTDATABASE         = $000001FC;      // SSCE_DBINIT
  DBPROP_SSCE_DEFAULT_LOCK_ESCALATION = $000001FD;      // SSCE_DBINIT
  DBPROP_SSCE_TEMPFILE_DIRECTORY      = $000001FE;      // SSCE_DBINIT
  DBPROP_SSCE_DEFAULT_LOCK_TIMEOUT    = $000001FF;      // SSCE_DBINIT
  DBPROP_SSCE_TRANSACTION_COMMIT_MODE = $00000200;      // SSCE_SESSION
  DBPROP_SSCE_LOCK_TIMEOUT            = $00000201;      // SSCE_SESSION
  DBPROP_SSCE_AUTO_SHRINK_THRESHOLD   = $00000202;      // SSCE_DBINIT
  DBPROP_SSCE_FLUSH_INTERVAL          = $00000206;      // SSCE_DBINIT
  DBPROP_SSCE_MAX_DATABASE_SIZE       = $0000020B;      // SSCE_DBINIT
  DBPROP_SSCE_LOCK_ESCALATION         = $0000020C;      // SSCE_SESSION
  DBPROP_SSCE_LOCK_HINT               = $0000020D;      // SSCE_ROWSET
  DBPROP_SSCE_TEMPFILE_MAX_SIZE       = $0000020E;      // SSCE_DBINIT

// Enumeration values for DBPROP_SSCE_LOCK_HINT:
const
  DBPROPVAL_SSCE_LH_ROWLOCK  = $00000001;     // Row-level locking
  DBPROPVAL_SSCE_LH_PAGLOCK  = $00000002;     // Page-level locking
  DBPROPVAL_SSCE_LH_TABLOCK  = $00000004;     // Table-level locking
  DBPROPVAL_SSCE_LH_DBLOCK   = $00000008;     // Database-level locking
  DBPROPVAL_SSCE_LH_NOLOCK   = $00000010;     // No lock option
  DBPROPVAL_SSCE_LH_HOLDLOCK = $00000020;     // Hold lock option
  DBPROPVAL_SSCE_LH_UPDLOCK  = $00000040;     // Update lock type
  DBPROPVAL_SSCE_LH_XLOCK    = $00000080;     // Exclusive lock type

// Enumeration values for DBPROP_SSCE_TRANSACTION_COMMIT_MODE:
const
  DBPROPVAL_SSCE_TCM_DEFAULT = $00000000;     // Asynchronously commit transactions to disk
  DBPROPVAL_SSCE_TCM_FLUSH   = $00000001;     // Synchronously commit transactions to disk
  ...
  SSCE_DBINIT_CONFLICT_MAXBUFFERSIZE         = $00000001;
  SSCE_DBINIT_CONFLICT_AUTO_SHRINK_THRESHOLD = $00000004;
  SSCE_DBINIT_CONFLICT_FLUSH_INTERVAL        = $00000008;
  SSCE_DBINIT_CONFLICT_MAX_DATABASE_SIZE     = $00000020;
  SSCE_DBINIT_CONFLICT_TEMPFILE_DIRECTORY    = $00000040;
  SSCE_DBINIT_CONFLICT_DEFAULTESCALATION     = $00000080;
  SSCE_DBINIT_CONFLICT_DEFAULTTIMEOUT        = $00000100;
  SSCE_DBINIT_CONFLICT_MAX_TMPDB_SIZE        = $00000200;
...
// *********************************************************************//
  ...
  DBROWSTATUS = UINT;
  PDBROWSTATUS = IntPtr; // ^DBROWSTATUS;
  PPDBROWSTATUS = IntPtr; // ^PDBROWSTATUS;
...
const
  DBPROPSET_SQLSERVERDBINIT: TGUID =
    '{5cf4ca10-ef21-11d0-97e7-00c04fc2ad98}';
  DBPROPSET_SQLSERVERROWSET: TGUID =
    '{5cf4ca11-ef21-11d0-97e7-00c04fc2ad98}';
  DBPROPSET_SQLSERVERDATASOURCE: TGUID =
    '{28efaee4-2d2c-11d1-9807-00c04fc2ad98}';
  ...
  // PropIds for DBPROPSET_SQLSERVERDBINIT - MS SQL Server 2000 specific
  SSPROP_INIT_ENCRYPT             = 13;
  // SSPROP_AUTH_REPL_SERVER_NAME    = 14;
  // SSPROP_INIT_TAGCOLUMNCOLLATION  = 15;

  SSPROP_INIT_MARSCONNECTION           = 16; // MS SQL Server 2005 specific
  SSPROP_INIT_FAILOVERPARTNER          = 18; // MS SQL Server 2005 specific
  SSPROP_AUTH_OLD_PASSWORD             = 19; // MS SQL Server 2005 specific
  SSPROP_INIT_TRUST_SERVER_CERTIFICATE = 21; // MS SQL Server 2005 specific
  ...
  SSPROPVAL_DEFAULT_NOTIFICATION_TIMEOUT = 432000; // in seconds
  SSPROPVAL_MAX_NOTIFICATION_TIMEOUT     = $7FFFFFFF; // in seconds
  ...
  DBSCHEMA_LINKEDSERVERS: TGUID	=
    '{9093caf4-2eac-11d1-9809-00c04fc2ad98}';
  DBSCHEMA_SQL_ASSEMBLIES: TGUID =
    '{7c1112c8-c2d3-4f6e-949a-983d38a58f46}';
  DBSCHEMA_SQL_ASSEMBLY_DEPENDENCIES: TGUID =
    '{cb0f837b-974c-41b8-909d-649caf45ad2f}';
  DBSCHEMA_SQL_USER_TYPES: TGUID =
    '{f1198bd8-a424-4ea3-8d4c-607eee2bab60}';
  DBSCHEMA_XML_COLLECTIONS: TGUID =
    '{56bfad8c-6e8f-480d-91de-3516d99a5d10}';

  CRESTRICTIONS_DBSCHEMA_LINKEDSERVERS = 1;
  {$EXTERNALSYM CRESTRICTIONS_DBSCHEMA_LINKEDSERVERS}

  CRESTRICTIONS_DBSCHEMA_SQL_ASSEMBLIES = 4;
  {$EXTERNALSYM CRESTRICTIONS_DBSCHEMA_SQL_ASSEMBLIES}

  CRESTRICTIONS_DBSCHEMA_SQL_ASSEMBLY_DEPENDENCIES = 4;
  {$EXTERNALSYM CRESTRICTIONS_DBSCHEMA_SQL_ASSEMBLY_DEPENDENCIES}

  CRESTRICTIONS_DBSCHEMA_SQL_USER_TYPES = 3;
  {$EXTERNALSYM CRESTRICTIONS_DBSCHEMA_SQL_USER_TYPES}

  CRESTRICTIONS_DBSCHEMA_XML_COLLECTIONS = 4;
  {$EXTERNALSYM CRESTRICTIONS_DBSCHEMA_XML_COLLECTIONS}

  IID_IRowsetBookmark: TGUID =
    '{0c733ac2-2a1c-11ce-ade5-00aa0044773d}';
  
  IID_IErrorRecords: TGUID =
    '{0c733a67-2a1c-11ce-ade5-00aa0044773d}';
  {$EXTERNALSYM IID_IErrorRecords}

  IID_ISQLServerErrorInfo: TGUID =
    '{5cf4ca12-ef21-11d0-97e7-00c04fc2ad98}';

  CLSID_SQLOLEDB: TGUID =
    '{0C7FF16C-38E3-11d0-97AB-00C04FC2AD98}'; {SQLOLEDB CLSID}
  CLSID_SQLNCLI: TGUID =
    '{85ECAFCC-BDD9-4B03-97A8-FA65CBE3859B}'; {SQLNCLI CLSID}
  CLSID_SQLSERVERCE_3_0: TGUID = '{32CE2952-2585-49a6-AEFF-1732076C2945}';

(*  CLSID_ORAOLEDB: TGUID =
