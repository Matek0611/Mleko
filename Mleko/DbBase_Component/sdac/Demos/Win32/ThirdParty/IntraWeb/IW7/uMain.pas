...
uses
  ...
  DB, MemDS, DBAccess, MSAccess, MsConnectionPool, IWHTMLControls, IWCompButton,
  IWGrids, IWDBGrids, IWDBStdCtrls, IWCompMemo, IWCompEdit, IWContainer,
  IWRegion, IWCompCheckbox, IWCompListbox, IWVCLBaseContainer, IWHTMLContainer,
