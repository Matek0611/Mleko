...
Daniele Teti, Ignacio Trivino and Samuel J. Comstock.
...
type
  ...
  private
    ...
    procedure OneBarProps(code:char; var Width:integer; var lt:TfrBarLineType);
  ...
  published
   ...
   { build CheckSum ? }
    ...
    property CheckSumMethod:TfrCheckSumMethod read FCheckSumMethod write FCheckSumMethod default csmModulo10;
...
function TfrBarcode.GetWidth:integer;
var
  data:string;
  i:integer;
  w:integer;
...
procedure TfrBarcode.SetWidth(Value:integer);
var
  data:string;
  i:integer;
  w, wtotal:integer;
...
function TfrBarcode.DoCheckSumming(const data:string):string;
begin
...
function TfrBarcode.Code_39:string;
...
function TfrBarcode.Code_93:string;
type TCode93 =
  record
    c:char;
...
function TfrBarcode.Code_PostNet:string;
...
function TfrBarcode.Code_Codabar:string;
type TCodabar =
  record
    c:char;
