...
function TfrDBXDatabase.GetParams:TStrings;
begin
  FParams.Assign(FDatabase.Params);
  Result:= FParams;
end;
...
begin
  ...
  if Result = Null then
    Result:= LinesMethod(GetParams, MethodName, 'PARAMS', Par1, Par2, Par3);
end;
