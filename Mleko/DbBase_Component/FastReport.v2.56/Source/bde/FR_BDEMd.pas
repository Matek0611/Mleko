...
uses
  ...
  DB, DBTables, ExtCtrls, StdCtrls, FR_Const;

type
  TfrBDEFieldsLinkForm = class(TForm)
    DetailL:TListBox;
    MasterL:TListBox;
    Label1:TLabel;
    Label2:TLabel;
...
procedure TfrBDEFieldsLinkForm.FillLists;
var
  i:Integer;
  s:String;
begin
...
procedure TfrBDEFieldsLinkForm.FormShow(Sender:TObject);
var
  i:Integer;
begin
...
procedure TfrBDEFieldsLinkForm.FormHide(Sender:TObject);
begin
...
procedure TfrBDEFieldsLinkForm.ClearBClick(Sender:TObject);
begin
  FCurFields:= '';
  FillLists;
end;

procedure TfrBDEFieldsLinkForm.DetailLDrawItem(Control:TWinControl;
...
procedure TfrBDEFieldsLinkForm.DetailLClick(Sender:TObject);
begin
...
procedure TfrBDEFieldsLinkForm.MasterLClick(Sender:TObject);
begin
  if DetailL.ItemIndex<>-1 then
    AddB.Enabled:= True;
end;

procedure TfrBDEFieldsLinkForm.AddBClick(Sender:TObject);
var s:String;
begin
...
procedure TfrBDEFieldsLinkForm.Localize;
begin
...
procedure TfrBDEFieldsLinkForm.FormCreate(Sender:TObject);
begin
  Localize;
end;
