...
procedure TfrBDEDataset.SaveToFR3Stream(Stream:TStream);
...
begin
  inherited;
  WriteStr(' DatabaseName="'+StrToXML(FDataSet.DatabaseName)+'"');
...
procedure TfrBDETable.SaveToFR3Stream(Stream:TStream);
