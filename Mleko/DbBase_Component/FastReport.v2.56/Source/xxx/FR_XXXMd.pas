...
uses
  ...
  DB, UXXXTable, ExtCtrls, StdCtrls, FR_Const;

type
  TfrXXXFieldsLinkForm = class(TForm)
    DetailL:TListBox;
    MasterL:TListBox;
    Label1:TLabel;
    Label2:TLabel;
...
procedure TfrXXXFieldsLinkForm.FillLists;
var
  i:Integer;
  s:String;
begin
...
procedure TfrXXXFieldsLinkForm.FormShow(Sender:TObject);
var
  i:Integer;
begin
...
procedure TfrXXXFieldsLinkForm.FormHide(Sender:TObject);
begin
...
procedure TfrXXXFieldsLinkForm.ClearBClick(Sender:TObject);
begin
  FCurFields:= '';
  FillLists;
end;

procedure TfrXXXFieldsLinkForm.DetailLDrawItem(Control:TWinControl;
...
procedure TfrXXXFieldsLinkForm.DetailLClick(Sender:TObject);
begin
...
procedure TfrXXXFieldsLinkForm.MasterLClick(Sender:TObject);
begin
  if DetailL.ItemIndex<>-1 then
    AddB.Enabled:= True;
end;

procedure TfrXXXFieldsLinkForm.AddBClick(Sender:TObject);
var s:String;
begin
...
procedure TfrXXXFieldsLinkForm.Localize;
begin
...
procedure TfrXXXFieldsLinkForm.FormCreate(Sender:TObject);
begin
  Localize;
end;
